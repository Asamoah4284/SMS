import { Users, GraduationCap, Banknote, CalendarCheck, Megaphone, Plus, ArrowRight, type LucideIcon } from "lucide-react";
...
function StatCard({ label, value, icon: Icon, color, bg }: { label: string; value: string; icon: LucideIcon; color: string; bg: string }) {
  return (
