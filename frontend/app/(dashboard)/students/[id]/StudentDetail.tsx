    ...
    <div className="p-8 max-w-[1200px] mx-auto animate-fade-in space-y-6">
      ...
      <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-[var(--shadow-card)]">
        <div className="flex items-start gap-5 flex-wrap">
          <div className="w-16 h-16 rounded-2xl bg-primary-100 text-primary-700 flex items-center justify-center font-bold text-xl flex-shrink-0">
            {initials}
          </div>
          ...
          {student.class && (
            <Link
              ...
              className="flex items-center gap-2.5 bg-primary-50 border border-primary-200 rounded-xl px-4 py-2.5 hover:bg-primary-100 transition-colors"
            >
              <GraduationCap className="w-4 h-4 text-primary-600" />
              <div>
                <p className="text-xs text-primary-500 font-medium">Class</p>
                <p className="text-sm font-bold text-primary-700">{student.class.name}</p>
              </div>
  ...
  return (
    <div className="grid md:grid-cols-2 gap-5">
        ...
        <dl className="space-y-3">
          ...
          {student.class && (
            <InfoRow icon={<GraduationCap className="w-4 h-4" />} label="Class">
              <Link href={`/classes/${student.class.id}`} className="font-semibold text-primary-700 hover:underline flex items-center gap-1">
                {student.class.name}
          ...
          {student.class?.classTeacher && (
            <InfoRow icon={<UserCheck className="w-4 h-4" />} label="Class Teacher">
              <Link href={`/teachers/${student.class.classTeacher.id}`} className="font-semibold text-primary-700 hover:underline flex items-center gap-1">
          ...
          <dl className="space-y-3">
            {parentName && (
              <InfoRow icon={<Users className="w-4 h-4" />} label="Name">
                {parentLinked && student.parent ? (
                  <Link href={`/parents/${student.parent.id}`} className="font-semibold text-primary-700 hover:underline flex items-center gap-1">
            ...
            {parentPhone && (
              <InfoRow icon={<Phone className="w-4 h-4" />} label="Phone">
                <a href={`tel:${parentPhone}`} className="font-semibold text-primary-700 hover:underline">
                  {parentPhone}
                </a>
              </InfoRow>
            )}
                  ...
                  {student.parent.children
                    ...
                    .map((sib) => (
                      <Link
                        ...
                        className="px-2 py-0.5 bg-gray-100 hover:bg-primary-50 text-gray-700 hover:text-primary-700 text-xs font-semibold rounded-full transition-colors"
                      >
      ...
      {student.attendanceSummary.total > 0 && (
        <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-[var(--shadow-card)] md:col-span-2">
          <h3 className="font-bold text-gray-900 mb-4">Attendance Summary (Last 30 Records)</h3>
  ...
  return (
    <div className="space-y-5">
      {Object.entries(byTerm).map(([termLabel, termResults]) => {
        ...
        return (
          <div key={termLabel} className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-[var(--shadow-card)]">
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-3 gap-4">
        {[
          ...
          <div key={label} className="bg-white border border-gray-200 rounded-2xl p-5 shadow-[var(--shadow-card)] text-center">
            <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider mb-1">{label}</p>
